...
LIBOBJS=fortress_info.o fortress_util.o randlib.o fortress_random_t.o as63.o fortress_prior_t.o fortress_linalg.o filter.o  fortress_model_t.o fortress_particles_t.o fortress_particle_filter.o fortress_smc_t.o gensys.o
...
test_driver: test_driver.f90 $(LOBJS) test_model_t.o test_model.o test_prior.o test_random.o test_linalg.o test_smc.o test_util.o test_particles.o test_particle_filter.o 
	$(FC) $^  -I. $(FRUIT) $(FLAP) $(FORTRESS) -llapack  -o $@ 
